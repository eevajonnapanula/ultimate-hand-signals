...
const translations: Record<Language, Translations> = {
    ...
    footer: (
      <p>
        Tämän sivun on tehnyt <a href="https://eevis.codes">Eevis</a>, ja
        tekemiseen on käytetty paljon 💖 sekä ☕️.
      </p>
    ),
    aboutPage: (
      <section>
        ...
        <p>
          Tämä sivusto on tehty helpottamaan ultimaten käsimerkkien opettelua.
        </p>
  ...
  en: {
    ...
    aboutPage: (
      <section>
        ...
        <p>
          This site was created in order to make learning hand signals for
          ultimate frisbee easier.
        </p>
